      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-6 space-y-6">
          ...
          <div>
            ...
            />
            <p className="text-[11px] text-gray-600 mt-1">Önerilen boyut: 230×600px (veya 230×300; PNG/JPG)</p>
          </div>
                  ...
                  <div className="rounded-2xl overflow-hidden border border-white/10 shadow-lg shadow-black/50 bg-black/20">
                    {!previewError ? (
                      ...
                      <img
                        ...
                        width={230}
                        height={600}
                        className="block w-full max-w-[230px] h-auto object-contain object-top"
